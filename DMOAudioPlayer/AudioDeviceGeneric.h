#ifndef __AUDIO_DEVICE_GENERIC_H__
#define __AUDIO_DEVICE_GENERIC_H__
#pragma once

// #include "modules/audio_device/audio_device_buffer.h"
// #include "modules/audio_device/include/audio_device.h"

class AudioDeviceGenericInterface {
public:
    ...
    virtual void AttachAudioBuffers(AudioDevicePlayoutBufferInterface::ptr outBuffer, AudioDeviceRecordingBufferInterface::ptr inBuffer) = 0;

    virtual ~AudioDeviceGenericInterface() {}
};

class AudioDevicePlayoutInterface
    : public AudioDeviceGenericInterface
{
public:
    // Device enumeration
    virtual int16_t PlayoutDevices() = 0;
    virtual int32_t PlayoutDeviceName(const uint16_t index, std::wstring& name, std::wstring& guid) = 0;
...
class AudioDeviceRecordingInterface
    : public AudioDeviceGenericInterface 
{
public:
    // Device enumeration
    virtual int16_t RecordingDevices() = 0;
    virtual int32_t RecordingDeviceName(const uint16_t index, std::wstring& name, std::wstring& guid) = 0;
...
#endif __AUDIO_DEVICE_GENERIC_H__